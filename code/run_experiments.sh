...
PREFIX=2
python run_pretraining.py --model_name GBert-pretraining-${PREFIX} --num_train_epochs 5 --do_train
...
for i in {1..15} 
do
python run_pretraining.py --model_name GBert-pretraining-${PREFIX} --use_pretrain --pretrain_dir ../saved/GBert-predict-${PREFIX} --num_train_epochs 5 --do_train
python run_gbert.py --model_name GBert-predict-${PREFIX} --use_pretrain --pretrain_dir ../saved/GBert-pretraining-${PREFIX} --num_train_epochs 5 --do_train
done